...
- (id)init {
    if ((self = [super init])) {
        ...
        self.lightColor = [UIColor colorWithRed:152/255.0 green:125/255.0 blue:61/255.0 alpha:1.0];
        self.darkColor = [UIColor colorWithRed:91/255.0 green:68/255.0 blue:5/255.0 alpha:1.0];
    }
    return self;
}
